...
<div id="content">
    ...
    <table class="tab2">
        ...
        <tr>
            ...
            <td><input id="title" type="text" name="title" maxlength="255" value="{{ news.title }}"></td>
        </tr>
        <tr>
            <td>Дата публикации (дд.мм.гггг)</td>
            <td><input id="date" type="date" name="date" value="{{ news.date }}"></td>
        </tr>
        <tr>
            <td>Текст новости</td>
            <td><textarea id="text" name="text" cols="30" rows="4">{{ news.text }}</textarea></td>
        </tr>
        <tr>
